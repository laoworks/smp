...
<div class="mx-auto max-w-7xl">
    <div id="admin-resource-live-container">
        @include('admin.resources._index-content')
    </div>
</div>
...
function confirmDelete(id, title)
{
    Swal.fire({
        title: 'Hapus Data?',
        text: `Data ${title} tidak dapat dikembalikan.`,
        icon: 'warning',
...
document.addEventListener('DOMContentLoaded', function () {
    const container = document.getElementById('admin-resource-live-container');
